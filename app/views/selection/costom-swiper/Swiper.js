...
class Swiper extends Component {
  ...
  renderFirstCard = () => {
    ...
    return (
      ...
      >
        ...
        <View style={{ zIndex: -1, height: '100%', width: '100%' }}>{firstCard}</View>
        {renderOverlayLabel}
  ...
  renderStack = () => {
    ...
    if (secondCardIndex > 0) {
      stackCount = cards.length - secondCardIndex + 1
    }
    else {
      fixnull = 0
    }
    ...
    for (var index = secondCardIndex; index < secondCardIndex + fixnull; index++) {
